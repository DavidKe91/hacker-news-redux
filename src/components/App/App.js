            ...
            <ThemeProvider theme={theme === themes.light ? colorsLight : colorsDark}>
                <div>
                    ...
                    <Wrapper>
                        <TitleWrapper>
                            <Title>
                                <div>{'Hacker News Redesign'}</div>
                            </Title>
                            <div>
                                <SocialLink href="https://github.com/DavidKe91" target="blank">
                                    <i className="fab fa-github" />
                                </SocialLink>
                                <SocialLink href="https://www.instagram.com/dave_tripper/" target="blank">
                                    <i className="fab fa-instagram" />
                                </SocialLink>
                                <SocialLink href="https://www.linkedin.com/in/davidky/" target="blank">
                                    <i className="fab fa-linkedin" />
                                </SocialLink>
                                <SocialLink href="http://davidgkennedy.com/" target="blank">
